...
int main(){
	/*
	OBS: Não fiz os cin conseguirem pescar os nomes e outras informaçoes com espaço, visto que eu quero evitar pegar caracter de espaço por conta de estar trabalhando com arquivos.
	*/
	Banco meuBanco("Luiz", "65.737.800/0001-35", "BancoMedeiros");
